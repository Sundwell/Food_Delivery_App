    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.DecimalField(decimal_places=2, default=0, max_digits=12, null=True, validators=[django.core.validators.MinValueValidator(0, 'Wrong weight')])),
                ('calories', models.PositiveIntegerField(default=0, null=True, verbose_name='Calories')),
                ('carbohydrates', models.PositiveIntegerField(default=0, null=True)),
                ('proteins', models.PositiveIntegerField(default=0, null=True)),
                ('fats', models.PositiveIntegerField(default=0, null=True)),
